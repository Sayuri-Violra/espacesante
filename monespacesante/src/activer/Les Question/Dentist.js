...
const Dentist = () => {
  ...
  return (
    <div>
      <a href="/Doc" className="Retour">
        <img src={Arrow} className="Arrow" /> &nbsp;
        Etape précédente
      </a>
      <progress className="Bar" id="loading-bar" value="60" max="100" ></progress>
      <h2 className="JeSuis">J'ai vu mon dentiste au cours de la dernière année</h2>
      ...
      {isSuivantVisible && ( // Show "Suivant" button only if an option is selected
        <button className="Continuer">
          <Link className="Repair" to="/Tension">
            Suivant
          </Link>
        </button>
      )}
